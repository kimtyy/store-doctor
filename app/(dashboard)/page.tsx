  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-6 pb-32">
      <div className="mx-auto max-w-2xl space-y-6">
        {/* 헤더 */}
        <div>
          <p className="text-sm text-slate-400">오늘 ({new Date().toLocaleDateString('ko-KR', { month: 'short', day: 'numeric', weekday: 'short' })})</p>
          <h1 className="mt-2 text-3xl font-bold text-slate-100">매장 진단</h1>
        </div>
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-5">
          <h2 className="text-lg font-semibold text-slate-100">매출 추이</h2>
