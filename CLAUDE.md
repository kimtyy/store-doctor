...
### 원인 분석
- **스토어 ID 불일치**: 이전 로직에 임시 하드코딩되어 있던 매장 ID(`8de2930d-a196-4aa1-b9bf-7fa83321b10c`)가 데이터베이스의 실제 사용 중인 매장 ID(`23197c4f-5bec-40e2-b494-826083721faa`)와 어긋나 401 Unauthorized 혹은 빈 데이터를 반환하고 있었음.
